...
class TestChip:
    ...
    def synth(self):
        ...
        dif_log = os.path.join(config.HERD_LOG_DIR_PATH,'dif_litmus_C910_RVWMO.log')
        ...
        with open(exp_3_output_log_path, 'w') as f:
            ...
            patch, ppo_list = synth_by_test_pattern_online(None, cur_mm, litmus_test_suite, None, mode='chip', chip_log_path = tgt_log, iterate_count=1)
