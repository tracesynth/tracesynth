...
(define-litmus-test test/x86/MP-1
  (((W X 1)
    (W Y 1))
   ((R Y 1)
    (R X 0)))
...
(define-litmus-test test/x86/MP-2
  (((W X 1)
    (W Y 1))
   ((R Y 0)
    (R X 0)))
...
(define-litmus-test test/x86/MP-3
  (((W X 1)
    (W Y 1))
   ((R Y 0)
    (R X 1)))
...
(define-litmus-test test/x86/MP-4
  (((W X 1)
    (W Y 1))
   ((R Y 1)
    (R X 1)))
...
(define-litmus-test test/x86/SB-1
  (((W X 1)
    (R Y 0))
   ((W Y 1)
    (R X 1)))
...
(define-litmus-test test/x86/SB-2
  (((W X 1)
    (R Y 1))
   ((W Y 1)
    (R X 0)))
...
(define-litmus-test test/x86/SB-3
  (((W X 1)
    (R Y 1))
   ((W Y 1)
    (R X 1)))
...
(define-litmus-test test/x86/SB-4
  (((W X 1)
    (R Y 0))
   ((W Y 1)
    (R X 0)))
...
(define-litmus-test test/x86/LB-1
  (((R X 1)
    (W Y 1))
   ((R Y 1)
    (W X 1)))
...
(define-litmus-test test/x86/LB-2
  (((R X 1)
    (W Y 1))
   ((R Y 0)
    (W X 1)))
...
(define-litmus-test test/x86/LB-3
  (((R X 0)
    (W Y 1))
   ((R Y 1)
    (W X 1)))
...
(define-litmus-test test/x86/LB-4
  (((R X 0)
    (W Y 1))
   ((R Y 0)
    (W X 1)))
...
(define-litmus-test test/x86/2-2W-1
  (((W X 2)
    (W Y 1))
   ((W Y 2)
    (W X 1)))
...
(define-litmus-test test/x86/2-2W-2
  (((W X 2)
    (W Y 1))
   ((W Y 2)
    (W X 1)))
...
(define-litmus-test test/x86/2-2W-3
  (((W X 2)
    (W Y 1))
   ((W Y 2)
    (W X 1)))
...
(define-litmus-test test/x86/2-2W-4
  (((W X 2)
    (W Y 1))
   ((W Y 2)
    (W X 1)))
